...
local Window = OrionLib:MakeWindow({Name = "Hkhoaa Hub", HidePremium = false, IntroText = "Hkhoaa Library", SaveConfig = true, ConfigFolder = "Hkhoaa Hub"})
----------Tab-----------------------
...
elseif World3 then
	tableBoss = {"Hkhoaa Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
